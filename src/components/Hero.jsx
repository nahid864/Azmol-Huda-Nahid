...
import { RESUME_URL, GITHUB_URL, LINKEDIN_URL, MAIL_COMPOSE_URL } from '../config'
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ width: 520, height: 520, background: 'rgba(255,90,31,0.20)', top: '-14%', left: '-8%' }}
      />
      <div
        className="orb orb-drift depth-layer depth-far"
        style={{
          ...
          <div className="order-2 lg:order-1 space-y-6">
            ...
            <div className="reveal visible" style={{ transitionDelay: '0.3s' }}>
              <p className="text-brand-gray text-sm sm:text-base leading-relaxed max-w-lg">
                Full-stack web apps in Laravel, React and WordPress, cross-platform
                mobile in Flutter, and AI automation for the repetitive work. Web and
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end relative">
            ...
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 xl:w-96 xl:h-96 depth-layer depth-near">
              ...
              <div className="absolute -bottom-4 -left-4 bg-brand-card border border-brand-orange/40 rounded-xl px-4 py-3 shadow-xl float-chip">
                <p className="text-2xl font-extrabold text-white leading-none">2023</p>
                <p className="text-[10px] text-brand-gray uppercase tracking-wider mt-0.5">Building since</p>
              </div>
